...
type Config struct {
	...
	// DatabaseURL is the connection string. Empty is allowed and means the
	// process serves the static shell and nothing else — which is what the
	// image smoke test does, and what a `docker run` with no arguments should
	// keep doing.
	DatabaseURL string
